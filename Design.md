...
当前主流 AI 编程助手在面对**大规模、非主流语言、自研框架**的代码仓库时效果显著下降。其根本原因不是模型能力不足，而是**模型缺少足够的代码库上下文**。

本项目参考 [NVIDIA 与 EA 在大规模 C++ 代码库上的实践思路](https://www.youtube.com/watch?v=jFFOC3UZTTk)，构建一个全本地、零云端依赖的代码库索引与检索工具，以 MCP 协议对外暴露服务，使任意支持 MCP 的 AI 编程助手都能获得代码库级别的上下文理解能力。
